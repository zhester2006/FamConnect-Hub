from fastapi import FastAPI, APIRouter, HTTPException, Request, Response, Cookie, WebSocket, WebSocketDisconnect, UploadFile, File, Form
...
@api_router.get("/achievements/family")
...
@api_router.post("/achievements/streak/update")
...
@api_router.get("/achievements/seasonal")
...
@api_router.post("/achievements/seasonal")
...
@api_router.put("/dashboard/config")
...
@api_router.put("/dashboard/sections/reorder")
...
@api_router.put("/dashboard/sections/{section_id}/visibility")
...
@api_router.post("/goals/{goal_id}/increment")
