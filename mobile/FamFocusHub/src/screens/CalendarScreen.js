...
const styles = StyleSheet.create({
  ...
  eventTime: { color: '#a5b4fc', fontSize: 13 },
  creatorBadge: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  creatorAvatar: { width: 16, height: 16, borderRadius: 8 },
  creatorAvatarPlaceholder: { width: 16, height: 16, borderRadius: 8, backgroundColor: '#6366f1', justifyContent: 'center', alignItems: 'center' },
  creatorAvatarText: { color: '#fff', fontSize: 8, fontWeight: 'bold' },
  creatorName: { color: '#9ca3af', fontSize: 11 },
  deleteBtn: { padding: 8 },
  ...
  dayEventMeta: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 4 },
  dayEventTime: { color: '#a5b4fc', fontSize: 13 },
  dayEventCreator: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  dayEventCreatorAvatar: { width: 14, height: 14, borderRadius: 7 },
  dayEventCreatorAvatarPlaceholder: { width: 14, height: 14, borderRadius: 7, backgroundColor: '#6366f1', justifyContent: 'center', alignItems: 'center' },
  dayEventCreatorAvatarText: { color: '#fff', fontSize: 7, fontWeight: 'bold' },
  dayEventCreatorName: { color: '#9ca3af', fontSize: 10 },
