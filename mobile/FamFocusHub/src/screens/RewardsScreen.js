...
const styles = StyleSheet.create({
  ...
  unclaimBtn: { padding: 4 },
  claimedBadge: { backgroundColor: 'rgba(107, 114, 128, 0.3)', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  claimedBadgeText: { color: '#6b7280', fontSize: 11, fontWeight: '600' },
  approvalActions: { flexDirection: 'row', gap: 6 },
  approveTaskBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#10b981', justifyContent: 'center', alignItems: 'center' },
  denyTaskBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#ef4444', justifyContent: 'center', alignItems: 'center' },
